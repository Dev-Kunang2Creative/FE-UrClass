      ...
      <div className="w-full max-w-md mx-auto mt-20 flex flex-col items-center gap-6 text-center animate-in fade-in duration-300">
        ...
        <div className="flex gap-3 w-full">
          <button
            ...
            className="flex-1 py-3 border border-primary text-primary font-semibold rounded-lg hover:bg-track-tint transition-colors"
          >
            Riwayat Pembelian
          </button>
          <button
            onClick={() => router.push("/dashboard/try-out")}
            className="flex-1 py-3 bg-primary hover:bg-primary/90 text-white font-semibold rounded-lg transition-colors"
          >
            Mulai Try Out
          </button>
        </div>
      ...
      <div className="w-full max-w-md mx-auto mt-20 flex flex-col items-center gap-6 text-center animate-in fade-in duration-300">
        ...
        <div className="flex flex-col gap-3 w-full">
          <button
            ...
            className="w-full py-3 border border-primary text-primary font-semibold rounded-lg hover:bg-track-tint transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl w-full p-6 lg:p-8 flex flex-col gap-6 shadow-sm">
        {/* Package Title */}
        <div className="w-full bg-track-tint text-primary font-bold text-xl text-center py-4 rounded-xl">
          {pkg.title}
        </div>
        ...
        <button
          ...
          className="w-full py-3.5 bg-primary hover:bg-primary/90 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold rounded-xl transition-colors text-base shadow-sm"
        >
