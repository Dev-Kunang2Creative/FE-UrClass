          ...
          {hasUnanswered ? (
            <>
              ...
              <div className="flex w-full gap-3 pt-2">
                ...
                <button
                  onClick={onConfirm}
                  className="flex-1 bg-primary hover:bg-primary/90 text-white font-semibold py-3 rounded-xl transition-colors shadow-sm"
                >
            ...
            <>
              ...
              <div className="w-16 h-16 flex items-center justify-center mb-1">
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="48" height="48" rx="12" className="fill-track-tint"/>
                  <path d="M14 16h20v16H14V16z" className="stroke-primary" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M20 24l3 3 5-6" className="stroke-primary" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M14 16l10 8 10-8" className="stroke-primary" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <DialogTitle className="text-xl font-bold text-gray-900 mt-2">
