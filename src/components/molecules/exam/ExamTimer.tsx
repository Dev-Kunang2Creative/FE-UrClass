    ...
    <div
      className={`flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-bold border-2 transition-colors ${
        isLow
          ...
          : // Track-driven rather than a hardcoded blue. This component never
            // mentioned kategori, so it stayed blue on CPNS - the exact drift
            // that made the two tracks feel the same.
            "bg-track-tint text-primary border-track-border"
      }`}
    >
